...
def read_tfrecord(folder, image_shape, batch_size = 100, num_epochs = 100):
    ...
    images, labels = tf.train.shuffle_batch([image, label], batch_size=batch_size, capacity=100000, enqueue_many=True, allow_smaller_final_batch = True, num_threads=1, min_after_dequeue=0)
